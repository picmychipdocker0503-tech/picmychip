...
export const OrdersListView: React.FC<ListViewServerProps> = async ({ BeforeList, searchParams, user }) => {
  ...
  const initialData: ListApiResponse<Order> = {
    docs: result.docs,
  ...
  return (
    <div className="gutter--left gutter--right" style={{ paddingBlock: '2rem' }}>
      ...
      <p className="text-base-content/70 mb-6 text-sm">Customer orders and fulfillment.</p>
      {BeforeList}
