...
export const CategoriesListView: React.FC<ListViewServerProps> = async ({ BeforeList, searchParams, user }) => {
  ...
  const initialData: ListApiResponse<Category> = {
    docs: result.docs,
  ...
  return (
    <div className="gutter--left gutter--right" style={{ paddingBlock: '2rem' }}>
      ...
      <p className="text-base-content/70 mb-6 text-sm">Manage product categories.</p>
      {BeforeList}
