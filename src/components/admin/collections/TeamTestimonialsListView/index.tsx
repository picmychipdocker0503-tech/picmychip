...
import { TeamTestimonialsTable } from './TeamTestimonialsTable'
...
export const TeamTestimonialsListView: React.FC<ListViewServerProps> = async ({ BeforeList, searchParams, user }) => {
  ...
  const initialData: ListApiResponse<TeamTestimonial> = {
    docs: result.docs,
  ...
  return (
    <div className="gutter--left gutter--right" style={{ paddingBlock: '2rem' }}>
      <h1 className="mb-1 text-2xl font-bold">Team Testimonials</h1>
      <p className="text-base-content/70 mb-6 text-sm">Manage the people & culture quotes and team stories.</p>
      {BeforeList}
      <TeamTestimonialsTable initialData={initialData} />
    </div>
  )
}
