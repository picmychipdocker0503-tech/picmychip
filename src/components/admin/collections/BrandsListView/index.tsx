...
export const BrandsListView: React.FC<ListViewServerProps> = async ({ BeforeList, searchParams, user }) => {
  ...
  const initialData: ListApiResponse<Brand> = {
    docs: result.docs,
  ...
  return (
    <div className="gutter--left gutter--right" style={{ paddingBlock: '2rem' }}>
      <h1 className="mb-1 text-2xl font-bold">Brands</h1>
      <p className="text-base-content/70 mb-6 text-sm">Manage product brands.</p>
      {BeforeList}
