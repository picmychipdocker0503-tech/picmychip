...
/**
 * Mobile's own "Best Sellers This Month" row — a horizontal snap-scroll
 * carousel (same pattern as the CMS TrendingProducts block) instead of the
 * desktop grid squeezed into 2 columns, so each card gets full width to
 * breathe on a phone screen.
 */
export function MobileTrendingNow({ products, ratings }: Props) {
  return (
