...
const THEME_OPTIONS: ThemeOption[] = [
  ...
  },
  {
    ...
    swatch: { bg: 'oklch(6% 0 0deg)', primary: 'oklch(55% 0.12 300deg)' },
  },
  {
    value: 'warm',
    label: 'Warm',
    description: 'Cream & tan',
    swatch: { bg: 'oklch(97% 0.015 75deg)', primary: 'oklch(45% 0.22 300deg)' },
  },
  {
    value: 'ocean',
    label: 'Ocean',
    description: 'Deep navy blue',
    swatch: { bg: 'oklch(16% 0.03 250deg)', primary: 'oklch(62% 0.19 300deg)' },
  },
  {
    value: 'circuit',
    label: 'Circuit',
    description: 'PCB green',
    swatch: { bg: 'oklch(97% 0.015 150deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'sunset',
    label: 'Sunset',
    description: 'Coral & dusk',
    swatch: { bg: 'oklch(15% 0.03 20deg)', primary: 'oklch(65% 0.2 300deg)' },
  },
  {
    value: 'cupcake',
    label: 'Cupcake',
    description: 'Soft pink frosting',
    swatch: { bg: 'oklch(96% 0.02 350deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'bumblebee',
    label: 'Bumblebee',
    description: 'Golden & sweet',
    swatch: { bg: 'oklch(96% 0.02 90deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'emerald',
    label: 'Emerald',
    description: 'Cool mint green',
    swatch: { bg: 'oklch(96% 0.02 160deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'corporate',
    label: 'Corporate',
    description: 'Crisp steel blue',
    swatch: { bg: 'oklch(96% 0.02 240deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'synthwave',
    label: 'Synthwave',
    description: 'Retro neon glow',
    swatch: { bg: 'oklch(15% 0.03 320deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'retro',
    label: 'Retro',
    description: 'Vintage olive',
    swatch: { bg: 'oklch(96% 0.02 80deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'cyberpunk',
    label: 'Cyberpunk',
    description: 'Electric yellow',
    swatch: { bg: 'oklch(96% 0.02 95deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'valentine',
    label: 'Valentine',
    description: 'Rose & blush',
    swatch: { bg: 'oklch(96% 0.02 10deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'halloween',
    label: 'Halloween',
    description: 'Pumpkin night',
    swatch: { bg: 'oklch(15% 0.03 45deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'garden',
    label: 'Garden',
    description: 'Fresh botanical',
    swatch: { bg: 'oklch(96% 0.02 140deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'forest',
    label: 'Forest',
    description: 'Deep woodland',
    swatch: { bg: 'oklch(15% 0.03 150deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'aqua',
    label: 'Aqua',
    description: 'Teal deep sea',
    swatch: { bg: 'oklch(15% 0.03 200deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'autumn',
    label: 'Autumn',
    description: 'Burnt rust',
    swatch: { bg: 'oklch(96% 0.02 50deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'business',
    label: 'Business',
    description: 'Formal navy',
    swatch: { bg: 'oklch(15% 0.03 240deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'acid',
    label: 'Acid',
    description: 'Neon lime',
    swatch: { bg: 'oklch(96% 0.02 120deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'lemonade',
    label: 'Lemonade',
    description: 'Citrus fresh',
    swatch: { bg: 'oklch(96% 0.02 100deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'night',
    label: 'Night',
    description: 'Indigo dusk',
    swatch: { bg: 'oklch(15% 0.03 255deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'coffee',
    label: 'Coffee',
    description: 'Roasted brown',
    swatch: { bg: 'oklch(15% 0.03 50deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'winter',
    label: 'Winter',
    description: 'Icy pale blue',
    swatch: { bg: 'oklch(96% 0.02 220deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'dim',
    label: 'Dim',
    description: 'Muted twilight',
    swatch: { bg: 'oklch(15% 0.03 260deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'nord',
    label: 'Nord',
    description: 'Nordic frost',
    swatch: { bg: 'oklch(96% 0.02 225deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'caramellatte',
    label: 'Caramellatte',
    description: 'Warm latte',
    swatch: { bg: 'oklch(96% 0.02 70deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
  {
    value: 'abyss',
    label: 'Abyss',
    description: 'Deepest indigo',
    swatch: { bg: 'oklch(15% 0.03 270deg)', primary: 'oklch(64% 0.2 300deg)' },
  },
  {
    value: 'silk',
    label: 'Silk',
    description: 'Ivory smooth',
    swatch: { bg: 'oklch(96% 0.02 55deg)', primary: 'oklch(42% 0.27 300deg)' },
  },
]
