          ...
          : []),
        {
          ...
          channels: [
            {
              ...
              title: 'Bulk quote',
              description:
                'Send quantities or a BOM and get price breaks with available alternates.',
            ...
            },
            {
              ...
              title: 'Part guidance',
              description:
                'Ask about ratings, footprints, compatible modules, cables, and datasheets.',
            ...
            },
            {
              ...
              description:
                'Request PCB manufacturing, 3D printing, laser cutting, or battery packs.',
          ...
          steps: [
            ...
            },
            {
              ...
              detail:
                'Get suitable parts, alternates, lead times, and service paths in one response.',
            },
            {
              label: 'Confirm and track',
              detail:
                'Approve the quote or order, then follow dispatch and delivery from your account.',
            },
          ],
          metrics: [
